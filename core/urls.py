...
urlpatterns = [
    ...
    path(
        "flight/<str:flight_id>/book/",
        views.fill_booking_details,
        name="fill_booking_details",
    ),
    path(
        "flight/<str:flight_id>/payment/<str:booking_id>/pay/",
        views.book_flight,
        name="payment_flight",
    ),
    ...
    path(
        "bookings/<str:booking_id>/cancel/", views.cancel_flight, name="cancel_flight"
    ),
